...
(6, 4, '2021-07-01', 'B'), (4, 5, '2023-07-01', NULL),
...
INSERT INTO students (first_name, last_name, email, date_of_birth, department_id, enrollment_year) VALUES
('Harry', 'K', 'harry.k@college.edu', '2003-04-12', 1, 2022),
('Aakash', 'TS', 'aakash.ts@college.edu', '2003-07-25', 1, 2022)

update enrollments
set grade='B'
where student_id=5 and course_id=1;

select count(*) total_enrollments_after_update from enrollments;
...
select count(*) total_enrollments_after_delete from enrollments;